...
```powershell
python .\src\normalize\build_canonical_contract.py --project reference_001 --input .\data\extracted\reference_001 --output .\data\extracted\reference_001\canonical_json\contract.json
```
...
```powershell
python .\src\validate\validate_canonical_contract.py --input .\data\extracted\reference_001\canonical_json\contract.json --report .\data\reports\reference_001\validation_report.md
```

### 11.6 Vaihe 6: lataus PostgreSQL:aan

```powershell
python .\src\load\load_contract_package.py --input .\data\extracted\reference_001\canonical_json\contract.json --db postgresql://USER:PASSWORD@localhost:5432/cipp_contracts
```

### 11.7 Vaihe 7: chunkkaus ja embeddingit

```powershell
python .\src\embed\build_chunks.py --project reference_001
python .\src\embed\embed_chunks.py --project reference_001 --model MODEL_NAME
```
...
Tee `tests/eval_questions/reference_001.jsonl`.
...
{
  "draft_id": "draft_001",
  "based_on_projects": ["reference_001"],
  "contract": {
    "subject": "Viemärijärjestelmien CIPP-sukitusurakka",
    "standard_terms": "YSE 1998",
    "currency_code": "EUR"
